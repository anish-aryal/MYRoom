...
export default function RepostAd({action, type})  {
    ...
    const handleSubmit = async () => {
      try{
        ...
        const {data} = await axios.put(`/repostad/${ad._id}`,ad);
        if(data?.error){
          toast.error(data.error);
          setAd({...ad, loading:false});
        }
        else{
          toast.success('Ad has been reposted successfully');
          setAd({...ad, loading:false});
          navigate ("/dashboard");
        }
                       ...
                       { loaded? ( <CurrencyInput
                        ...
                        <div className="col-12 mt-4">
                          <div className="row justify-content-end">
                            ...
                            <button onClick={handleSubmit} type="button" className="login-btn" disabled={ad.loading} >{ad.loading ? "Reposting..." :"Repost"}</button>
                            </div>
                            <div className=" col-12 col-md-3">
