            ...
            <div className="row">
              <div className="col-12">
                <div className="chatheader">
                  <div className="d-flex justify-content-start align-items-center border-bottom mt-4">
...
//     return (  {chat?( <div className="container">
...
//                         <div className="sm ml-2 ">{userData?.firstname} {userData?.lastname}</div>
//                 </div>

//                     <div className="chat-body">
//                         {messages.map((message) => (
//                             <>
//                             <div className={message.senderId===currentUser?"Ownmessageown d-flex flex-column" :"sendersMessage d-flex flex-column"} >

//                                 <span>{message.text}</span>
//                                 <span className={message.senderId===currentUser?" text-right" :"text-left"}>{format(message.createdAt)}</span>
//                             </div>
//                             </>
//                         ))}
//                     </div>
...
//                         <button className="chat-send-button" onClick={handleSend}> Send Message</button>
...
//     </div>):(<span className='chatbox-empty-message'>Select a person to chat with</span>)}
// )
